    ...
    <form>
      <div className={styles.filterContainer}>
        ...
        <div className={styles.formGroup}>
          ...
          <input id="check-in" type="date" className={styles.formInput} />
        </div>
        <div className={styles.formGroup}>
          <label htmlFor="check-out">Check-out</label>
          <input id="check-out" type="date" className={styles.formInput} />
        </div>
        <div className={styles.formGroup}>
          <label htmlFor="numeroHospedes">N° de hóspedes</label>
          <input
            type="number"
            min="2"
            id="numeroHospedes"
